...
const displaySection = (hash) => {
  ...
  switch(hashSplit[0]) {
    ...
    case '#songs':
      // Comme l'URL ne match pas à #songs-:id, cela nous permet d'afficher la section "lyrics" correspondant à
...
// Changer la couleur de l'app, si on est online/offline en ajoutant/supprimant la class "offline" de body
